...
"Tko se smatra izumiteljem frižidera?",
    ...
    "Koji je srpoliki predmet bio lovačko oružje aboridžina?",
  ...
  void iscrtaj(){
    if( prva ){
      if(song3.isPlaying()==false){ //funkcionalnost koja omogućava da se vrti otkucaj sata dok vrijeme teče
